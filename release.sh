...
curl --fail -v  -H "Content-Type: application/json" -X POST --data '{"data":{"autoDropAfterRelease":true,"description":"Release","stagedRepositoryIds":["$3"]}}' -H "Authorization:Basic $1" -H "Content-Type:application/xml" https://oss.sonatype.org/service/local/staging/bulk/promote
